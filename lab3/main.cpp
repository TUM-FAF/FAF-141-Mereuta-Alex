...
TCHAR szClassName[ ] = _T("Let's paint some stuff");
                     ...
                     int nCmdShow)
{
    ...
    wincl.hbrBackground = CreateSolidBrush(RGB(150, 100, 100));
    ...
    hwnd = CreateWindowEx (
           ...
           _T("Let's draw some stuff"),       /* Title Text */
...
LRESULT CALLBACK WindowProcedure (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    switch (message)                  /* handle the messages */
    {
        ...
        case WM_CREATE:
        {
            ...
            RegisterHotKey(hwnd, HK_CLEAR, MOD_CONTROL, 0x43); // ctrl + c
            RegisterHotKey(hwnd, HK_ellipse, MOD_CONTROL, 0x45); //CTRL+E
        ...
        case WM_HOTKEY:
        {
            switch(wParam)
            {
                case HK_ellipse:                          //shortcut for ellipse  Ctrl + E
                ...
                case HK_CLEAR:                              //shortcut for clearing  CTRL + C
                {
